...
DEFAULT_MODEL_DOWNLOAD_SPECS: dict[ModelFileType, ModelFileDownloadSpec] = {
    "checkpoint": ModelFileDownloadSpec(
        ...
        description="Main transformer model (Fast/Distilled)",
    ),
    "pro_checkpoint": ModelFileDownloadSpec(
        relative_path=Path("ltx-2.3-22b-dev.safetensors"),
        expected_size_bytes=45_000_000_000,
        is_folder=False,
        repo_id="Lightricks/LTX-2.3",
        description="Pro transformer model (Dev/Undistilled)",
    ),
